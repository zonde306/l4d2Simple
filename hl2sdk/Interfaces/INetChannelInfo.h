...
#define SUBCHANNEL_TOSEND 1	
#define SUBCHANNEL_WAITING 2   
#define SUBCHANNEL_DIRTY 3	
...
public:
	...
	virtual void BIncomingMessageForProcessing(double, int, INetMessage*) = 0;
...
public:
	...
	inline netadr_s(const char *pch)
	{ 
		SetFromString(pch);
	}
	...
	inline void SetType(netadrtype_t type) 
	{ 
		this->type = type; 
	};
	...
	inline void SetIP(unsigned int unIP)
	{
	...
	inline void SetFromString(const char *pch, bool bUseDNS = false)
	{
	...
	inline netadrtype_t GetType() const 
	{ 
		return type;
	};
	...
	inline const char *ToString(bool onlyBase = false) const
	{
		std::stringstream ss;
	...
	inline bool IsReservedAdr() const
	{ 
...
public:
	...
	virtual void IsRemoteDisconnected() const = 0;
