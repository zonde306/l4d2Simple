...
template< class T, class I >
inline CUtlBlockMemory<T, I>::CUtlBlockMemory(int nGrowSize, int nInitAllocationCount)
...
template< class T, class I >
inline CUtlBlockMemory<T, I>::~CUtlBlockMemory()
{
	Purge();
}
...
//-----------------------------------------------------------------------------
template< class T, class I >
inline void CUtlBlockMemory<T, I>::Swap(CUtlBlockMemory< T, I > &mem)
{
...
__forceinline uint32_t SmallestPowerOfTwoGreaterOrEqual(uint32_t x)
{
	x -= 1;
	x |= x >> 1;
	x |= x >> 2;
...
//-----------------------------------------------------------------------------
template< class T, class I >
inline void CUtlBlockMemory<T, I>::Init(int nGrowSize /* = 0 */, int nInitSize /* = 0 */)
{
	Purge();
...
template< class T, class I >
inline void CUtlBlockMemory<T, I>::Grow(int num)
{
	if (num <= 0)
		return;
...
template< class T, class I >
inline void CUtlBlockMemory<T, I>::ChangeSize(int nBlocks)
{
...
//-----------------------------------------------------------------------------
template< class T, class I >
inline void CUtlBlockMemory<T, I>::Purge()
{
	if (!m_pMemory)
		return;
...
template< class T, class I >
inline void CUtlBlockMemory<T, I>::Purge(int numElements)
{
