...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	if (g_bHasShowMenu && ImGui::GetCurrentContext() != NULL)
	{
		ImGuiIO& io = ImGui::GetIO();
		bool hasMenuEvent = false;
	...
	return CallWindowProcA(g_pfnOldWndProcHandler, hwnd, msg, wParam, lParam);
}
